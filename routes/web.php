...
/*
  ...
  | contains the "web" middleware group. These route commonly used by all user
  |
 */
...
Route::group(['namespace' => 'App\Http\Controllers\Auth'], function() 
{
    ...
    Route::controller(VerificationController::class)->group(function () {
        Route::get('/email/resend', 'resend')->name('verification.emailresend');
...
Route::group(['namespace' => 'App\Http\Controllers'], function() 
{
    ...
    Route::group(['middleware' => ['auth']], function() {
        ...
        Route::controller(AddressController::class)->group(function () {
            ...
            Route::get('/addresses/destroy/{id}', 'destroy');
    ...
    */
    ...
    Route::controller(UploadController::class)->group(function () {
        Route::post('/sts-uploader', 'show_uploader');
        Route::post('/sts-uploader/upload', 'upload');
        Route::get('/sts-uploader/get_uploaded_files', 'get_uploaded_files');
        Route::post('/sts-uploader/get_file_by_ids', 'get_preview_files');
        Route::get('/sts-uploader/download/{id}', 'attachment_download')->name('download_attachment');
    });

    
    //this is for email verification and need install laravel ui
    Route::controller(HomeController::class)->group(function () {
        Route::get('/email_change/callback', 'email_change_callback')->name('email_change.callback');
        Route::post('/password/reset/email/submit', 'reset_password_with_code');
        ...
        Route::get('/productDetails/{slug}', 'productDetails')->name('product.details');
    ...
    Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function() {
        ...
        Route::controller(PurchaseHistoryController::class)->group(function () {
            ...
            Route::get('/purchase_history/destroy/{id}', 'order_cancel');
    ...
    Route::get('/customer-products/admin', [IyzicoController::class, 'initPayment']);
    ...
    Route::post('/states/{countryId}', function ($countryId) {
