...
Route::group(['namespace' => 'App\Http\Controllers\Admin', 'middleware' => ['auth', 'admin'],
'prefix'=>'admin','as'=>'admin.'], function() 
{
    ...
    Route::controller(BrandController::class)->group(function () {
        Route::get('/brands/edit/{id}', 'edit')->name('brands.getEdit');
        Route::get('/brands/destroy/{id}', 'destroy')->name('brands.getDestroy');
    });

    // Products
    Route::controller(ProductController::class)->group(function () {
        Route::get('/products/admin', 'admin_products')->name('admin_products');
    ...
    Route::controller(DigitalProductController::class)->group(function () {
        Route::get('/digitalproducts', 'index')->name('digitalproducts.index');
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::get('/sellers/destroy/{id}', 'destroy')->name('sellers.getdestroy');
    ...
    Route::controller(TaxController::class)->group(function () {
        Route::get('/tax/edit/{id}', 'edit')->name('tax.getedit');
        Route::get('/tax/destroy/{id}', 'destroy')->name('tax.getdestroy');
    ...
    Route::controller(LanguageController::class)->group(function () {
        Route::post('/languages/{id}/update', 'update')->name('languages.postupdate');
        Route::get('/languages/destroy/{id}', 'destroy')->name('languages.getdestroy');
    ...
    Route::group(['prefix' => 'website'], function() {
        ...
        Route::controller(PageController::class)->group(function () {
          Route::get('/custom-pages/edit/{id}', 'edit')->name('custom-pages.getedit');
          Route::get('/custom-pages/destroy/{id}', 'destroy')->name('custom-pages.getdestroy');
    ...
    Route::controller(RoleController::class)->group(function () {
        Route::get('/roles/edit/{id}', 'edit')->name('roles.getedit');
        Route::get('/roles/destroy/{id}', 'destroy')->name('roles.getdestroy');
    ...
    Route::controller(FlashDealController::class)->group(function () {
        Route::get('/flash_deals/edit/{id}', 'edit')->name('flash_deals.getedit');
        Route::get('/flash_deals/destroy/{id}', 'destroy')->name('flash_deals.getdestroy');
    ...
    Route::controller(BlogCategoryController::class)->group(function () {
        //Route::get('/blog/destroy/{id}', 'destroy')->name('blog.getdestroy');
        //Route::post('/blog/change-status', 'change_status')->name('blog.change-status');
        Route::get('/blog-category/destroy/{id}', 'destroy')->name('blog-category.getdestroy');
    });
    ...
    Route::controller(ConversationController::class)->group(function () {
        ...
        Route::get('/conversations/delete/{id}', 'destroy')->name('conversations.delete');
    });
    ...
    Route::controller(AttributeController::class)->group(function () {
        Route::get('/attributes/edit/{id}', 'edit')->name('attributes.getEdit');
        Route::get('/attributes/destroy/{id}', 'destroy')->name('attributes.getDestroy');
    ...
    Route::controller(CityController::class)->group(function () {
        Route::get('/cities/edit/{id}', 'edit')->name('cities.getedit');
        Route::get('/cities/destroy/{id}', 'destroy')->name('cities.getdestroy');
    ...
    // uploaded files
    Route::resource('/uploaded-files', UploadController::class);
    
    Route::controller(UploadController::class)->group(function () {
        Route::any('/uploaded-files/file-info', 'file_info')->name('uploaded-files.info');
        Route::get('/uploaded-files/destroy/{id}', 'destroy')->name('uploaded-files.getdestroy');
