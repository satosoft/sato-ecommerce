...
//Admin
Route::prefix('admin')->middleware(['auth', 'admin'])->namespace('App\Http\Controllers\Api\V2')->group(function(){
    // Auction product lists
    Route::controller('AuctionProductController')->group(function () {
    ...
    Route::controller('AuctionProductBidController')->group(function () {
...
Route::prefix('seller')-> middleware(['seller', 'verified', 'user'])->namespace('App\Http\Controllers\Api\V2')->group(function() {
    Route::controller('AuctionProductController')->group(function () {
...
Route::middleware('auth')->namespace('App\Http\Controllers\Api\V2')->group(function() {
...
Route::namespace('App\Http\Controllers\Api\V2')->controller(AuctionProductController::class)->group(function () {
