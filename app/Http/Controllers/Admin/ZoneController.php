...
class ZoneController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.setup_configurations.zones.index', compact('zones'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.setup_configurations.zones.create', compact('countries'));
    }
    ...
    public function edit(Zone $zone)
    {
        $countries = Country::where('status', 1)
                            ...
                            ->get();
        return view('admin.setup_configurations.zones.edit', compact('countries', 'zone'));
    }
