...
class CarrierController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.setup_configurations.carriers.index', compact('carriers'));
    }
    ...
    {
        $zones = Zone::get();
        return view('admin.setup_configurations.carriers.create',compact('zones'));
    }
    ...
    public function edit($id)
    {
        ...
        $zones = Zone::get();
        return view('admin.setup_configurations.carriers.edit',compact('zones','carrier'));
    }
